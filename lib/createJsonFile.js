...
var createJsonFile = function createJsonFile(name, vendor, version, description, eula, license) {
    const jsonObject = {
        ...
        "eula": eula,
        "license": license,
        "icon": `http://${name.toLowerCase().replace(/ /g, '')}-sap-rohitchouhan.loca.lt/icon.png`,
        "webcomponents": [{
                "kind": "main",
                "tag": `com-${vendor.toLowerCase().replace(/ /g, '')}-sap-${name.toLowerCase().replace(/ /g, '')}`,
                "url": `http://${name.toLowerCase().replace(/ /g, '')}-sap-rohitchouhan.loca.lt/${name.replace(/ /g, '')}/${name.replace(/ /g, '')}.js`,
                "integrity": "",
            ...
            },
            {
                ...
                "url": `http://${name.toLowerCase().replace(/ /g, '')}-sap-rohitchouhan.loca.lt/${name.replace(/ /g, '')}/${name.replace(/ /g, '')}_Builder.js`,
                "integrity": "",
                "ignoreIntegrity": true
            }
        ],
